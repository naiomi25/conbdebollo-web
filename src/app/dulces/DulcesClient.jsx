...
// 1. Recibimos el 'contenido' por aquí
export default function DulcesClient({ contenido }) {
    return (
        <main className="min-h-screen bg-fondo pt-12 pb-20">
            ...
            >
                ...
                <div className="text-center mb-16">
                    {/* 2. Usamos el título de Sanity o el tuyo por defecto */}
                    <h1 className="font-serif text-5xl text-principal mb-4">
                        {contenido?.titulo || "Nuestros Dulces"}
                    </h1>
                    <p className="text-texto max-w-2xl mx-auto text-lg">
                        {contenido?.descripcion || "Selecciona una categoría para descubrir todas nuestras variedades elaboradas diariamente."}
                    </p>
                </div>

                {/* Grid de Categorías (se queda igual) */}
