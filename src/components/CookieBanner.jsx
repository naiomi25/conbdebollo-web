    ...
    return (
        <AnimatePresence>
            {mostrar && (
                ...
                >
                    <div className="max-w-5xl mx-auto bg-tarjeta border border-principal/10 shadow-2xl rounded-2xl p-5 md:p-6 flex flex-col md:flex-row items-center justify-between gap-6 pointer-events-auto">
